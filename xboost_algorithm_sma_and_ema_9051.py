...
# Feature Engineering: Low Data Source Components
...
# Train XGBoost Model
xgb_model = xgb.XGBRegressor(objective='reg:squarederror', eval_metric='rmse', n_estimators=500, learning_rate=0.05, max_depth=3, subsample=0.8, colsample_bytree=0.8)
...
plt.legend()
plt.title('Optimized XGBoost with Low Data Source Components')
plt.xlabel('Days')
